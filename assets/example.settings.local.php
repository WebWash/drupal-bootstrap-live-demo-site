...
/**
 * IMPORTANT:
 * 1. Change the file name from "settings.webwash.php" to "settings.local.php".
 * 2. Scroll to the bottom and uncomment "$databases['default']['default']"
 *
 */
...
// Change details below as necessary.
// By default Lando settings are used.
